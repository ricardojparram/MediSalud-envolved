...
('1', 'Acetaminofén', 'Medicamento que reduce el dolor y la fiebre (pero no la inflamación).', 'aadsgdsg', 'C8H9NO2', 'Hipersensibilidad al acetaminofén o a cualquier otro componente del medicamento.', 'ASDGDSGSDAGDSAG', '2023-10-17', '12', '25', NULL, NULL, '1', '1', '1', '1'),
('2', 'Ibuprofeno', 'Medicamento que reduce el dolor y la fiebre (pero no la inflamación).', 'aadsgdsg', 'C8H9NO2', 'Hipersensibilidad al acetaminofén o a cualquier otro componente del medicamento.', 'ASDGDSGSDAGDSAG', '2023-10-17', '12', '25', NULL, NULL, '1', '1', '1', '1'),
('1', 'Omeprazol', 'Medicamento que reduce el dolor y la fiebre (pero no la inflamación).', 'aadsgdsg', 'C8H9NO2', 'Hipersensibilidad al acetaminofén o a cualquier otro componente del medicamento.', 'ASDGDSGSDAGDSAG', '2023-10-17', '12', '25', NULL, NULL, '1', '1', '1', '1'); 
