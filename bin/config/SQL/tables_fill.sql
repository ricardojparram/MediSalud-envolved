...
INSERT INTO producto (cod_producto, nombre, descripcion, ubicacion, composicion, contraindicaciones, posologia, vencimiento, p_venta, stock, img, cod_lab, cod_tipo, cod_clase, cod_pres, status) VALUES
(5, 'Acetaminofén', 'Medicamento que reduce el dolor y la fiebre (pero no la inflamación).', 'Pasillo 2', 'C8H9NO2', 'Los efectos secundarios más comunes son náuseas y salpullido. Las dosis altas de acetaminofén pueden causar daños hepáticos y renales.', 'Adultos: La dosis habitual es de 325 mg a 650 mg. Tómelo con una frecuencia de 4 a 6 horas, según sea necesario, hasta 4 veces en un período de 24 horas. La dosis máxima puede variar entre 3,000 mg y 4,000 mg, pero no tome más de 4,000 mg en un período de 24 horas. Siga todas las instrucciones de la etiqueta.', '2023-10-17', '12', '25', 'assets/img/productos/acetaminofen-650mg.png', NULL, 1, 2, 1, 1),
(6, 'Ibuprofeno', 'Su acción consiste en detener la producción del cuerpo de una sustancia que causa dolor, fiebre e inflamación.', 'Pasillo 1', 'C13H18O2', 'Historia de asma grave, urticaria o reacción alérgica a ácido acetilsalicílico u otros AINE. Pacientes con la tríada asma/rinitis con o sin poliposis nasal e intolerancia al ácido acetilsalicílico.', 'En adultos y adolescentes de 14 a 18 años se toma un comprimido (600 mg) cada 6 a 8 horas, dependiendo de la intensidad del cuadro y de la respuesta al tratamiento. En adultos la dosis máxima diaria es de 2.400 mg mientras que en adolescentes de 12 a 18 años es de 1.600 mg.', '2023-10-17', '12', '25', 'assets/img/productos/ibuprofeno600mg.png', NULL, 1, 6, 1, 1),
(7, 'Omeprazol', 'Medicamento que impide la secreción de ácido del estómago.', 'Pasillo 3', 'C17H19N3O3S', 'sarpullido, urticaria, picazón, hinchazón de los ojos, cara, labios, boca, garganta o lengua; dificultad para respirar o tragar o ronquera. ritmo cardíaco irregular, rápido o fuerte; espasmos musculares; temblores incontrolables de una parte del cuerpo; cansancio excesivo; aturdimiento; mareos; o convulsiones.', 'En algunos pacientes puede ser suficiente una dosis diaria de 10 mg. En caso de fracaso del tratamiento, se puede aumentar la dosis a 40 mg. La dosis recomendada es de 20 mg de omeprazol una vez al día.', '2023-10-17', '12', '25', 'assets/img/productos/omeprazol20mg.png', NULL, 1, 3, 1, 1),
(8, 'Cetirizina', 'Su función consiste en bloquear la acción de la histamina, una sustancia en el cuerpo que causa los síntomas de la alergia.', 'Pasillo 5', 'C21H25N2ClO', 'Hipersensibilidad a la cetirizina, hidroxicina u otro derivado piperazínico.\r\nPacientes con insuficiencia renal grave con un aclaramiento renal inferior a 10 ml/min.\r\n', 'Niños de 6 a 12 años: 5 mg dos veces al día (medio comprimido dos veces al día). Adultos y adolescentes mayores de 12 años: 10 mg una vez al día (un comprimido). Pacientes de edad avanzada: Los datos no sugieren que se necesite reducir la dosis en pacientes de edad avanzada en los que la función renal es normal.', '2023-11-24', '13.00', '423', 'assets/img/productos/cetirizina10mg.png', NULL, 2, 4, 5, 1),
(9, 'Fortasec', 'Es un medicamento antidiarreico, reduce los movimientos y secreciones intestinales, lo que disminuye las deposiciones líquidas.', 'Pasillo 5', 'loperamida hidrocloruro', 'Si es alérgico al hidrocloruro de loperamida o a cualquiera de los demás componentes de este medicamento (incluidos en la sección 6). Si aparece sangre en heces o tiene fiebre elevada (superior a 38ºC). Si sufre colitis ulcerosa (inflamación del intestino).', '2 cápsulas (4 mg) como dosis inicial seguida de 1 cápsula (2 mg) tras cada deposición diarreica. La dosis máxima para adultos es de 8 cápsulas (16 mg) al día. ', '2023-11-24', '33.00', '423', 'assets/img/productos/Fortasec20mg.png', NULL, 2, 4, 5, 1),
(10,'Fluconazol', 'Es una toxina triazol antimicótico usado en el tratamiento y prevención de infecciones fúngicas superficiales y sistémicas.', 'Pasillo 5', 'C13H12N6F2O', 'Nunca debe administrase a pacientes con hipersensibilidad a los compuestos azólicos o a alguno de los excipientes.', 'No se deberá sobrepasar la dosis máxima diaria de adultos (800 mg/día), aunque la ficha técnica en Pediatría no recomienda superar los 400-600 mg/día.', '2023-11-24', '14.00', '423', 'https://www.lasanteca.com/userfiles/2018/12/FLUCONAZOL-150MG-CAJA-POR-1-CAPSULA-INCLINADO.jpg', NULL, 2, 5, 5, 1);
